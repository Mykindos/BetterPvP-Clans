					...
					for (Player online : Bukkit.getOnlinePlayers()) {
						...
						if(MorphUtilities.isMorphed(dam)){
							...
							if(morph instanceof Wolf){
								UtilMessage.message(online, prefix, rolea + playerColour + p.getName() + ChatColor.GRAY + " was mauled to death by a " 
										+ ChatColor.YELLOW + "Wolf" + ChatColor.GRAY + " ("  + killerColour + dam.getName() + ChatColor.GRAY + ")");
							}else if(morph instanceof Spider){
								UtilMessage.message(online, prefix, rolea + playerColour + p.getName() + ChatColor.GRAY + " was killed by a " 
										+ ChatColor.YELLOW + "Spider" + ChatColor.GRAY + " ("  + killerColour + dam.getName() + ChatColor.GRAY + ")");
							}else if(morph instanceof Blaze){
								UtilMessage.message(online, prefix, rolea + playerColour + p.getName() + ChatColor.GRAY + " was killed by a " 
										+ ChatColor.YELLOW + "Blaze" + ChatColor.GRAY + " ("  + killerColour + dam.getName() + ChatColor.GRAY + ")");
							}else if(morph instanceof IronGolem){
								UtilMessage.message(online, prefix, rolea + playerColour + p.getName() + ChatColor.GRAY + " was killed by an " 
										+ ChatColor.YELLOW + "Iron Golem" + ChatColor.GRAY + " ("  + killerColour + dam.getName() + ChatColor.GRAY + ")");
							}
