...
public class FieldsDiamondOre extends General{

	public FieldsDiamondOre(Clans i) {
		super(i, "Fields Diamond Ore",	new String[]{
				ChatColor.GRAY + "Mine " + ChatColor.GREEN + "5" + ChatColor.GRAY + " Diamond nodes at the fields",
		});
