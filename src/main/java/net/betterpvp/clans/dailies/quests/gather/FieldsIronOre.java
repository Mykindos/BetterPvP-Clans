...
public class FieldsIronOre extends General{

	public FieldsIronOre(Clans i) {
		super(i, "Fields Iron Ore",	new String[]{
				ChatColor.GRAY + "Mine " + ChatColor.GREEN + "5" + ChatColor.GRAY + " Iron nodes at the fields",
		});
