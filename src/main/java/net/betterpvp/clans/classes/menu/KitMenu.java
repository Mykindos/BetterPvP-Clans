...
public class KitMenu extends Menu {
    ...
    public KitMenu(Player p, boolean newPlayer) {
        super(p, 36, ChatColor.GREEN.toString() + ChatColor.BOLD + "Select a Class!", new Button[]{
                ...
                new KitButton(8, new ItemStack(Material.GOLD_HELMET), ChatColor.GREEN.toString() + ChatColor.BOLD + "Paladin Class"),
                new KitButton(17, new ItemStack(Material.GOLD_CHESTPLATE), ChatColor.GREEN.toString() + ChatColor.BOLD + "Paladin Class"),
                new KitButton(26, new ItemStack(Material.GOLD_LEGGINGS), ChatColor.GREEN.toString() + ChatColor.BOLD + "Paladin Class"),
                new KitButton(35, new ItemStack(Material.GOLD_BOOTS), ChatColor.GREEN.toString() + ChatColor.BOLD + "Paladin Class")});
