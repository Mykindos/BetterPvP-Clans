...
public class ClassSelectionPage extends Menu {
    ...
    public ClassSelectionPage(Player player) {
        super(player, 36, "Class Customisation", new Button[]{
                ...
                new Button(5, new ItemStack(Material.NETHERITE_HELMET).clone(), ChatColor.GREEN.toString() + ChatColor.BOLD + "Warlock Class"),
                new Button(14, new ItemStack(Material.NETHERITE_CHESTPLATE).clone(), ChatColor.GREEN.toString() + ChatColor.BOLD + "Warlock Class"),
                new Button(23, new ItemStack(Material.NETHERITE_LEGGINGS).clone(), ChatColor.GREEN.toString() + ChatColor.BOLD + "Warlock Class"),
                new Button(32, new ItemStack(Material.NETHERITE_BOOTS).clone(), ChatColor.GREEN.toString() + ChatColor.BOLD + "Warlock Class"),
