...
public class VotingCrate extends Crate {
    ...
    public VotingCrate() {
        ...
        loot.put(new ItemStack(Material.NETHERITE_SWORD, 1), 2.5);
        loot.put(new ItemStack(Material.NETHERITE_AXE, 1), 2.5);
        ...
        loot.put(new ItemStack(Material.NETHERITE_INGOT, 14), 50.0);
