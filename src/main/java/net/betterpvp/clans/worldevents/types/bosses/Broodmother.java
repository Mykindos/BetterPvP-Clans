...
import net.battleau.clans.worldevents.types.bosses.ads.Broodling;
import net.battleau.clans.worldevents.types.nms.BossCaveSpider;
import net.battleau.clans.worldevents.types.nms.BossSpider;
