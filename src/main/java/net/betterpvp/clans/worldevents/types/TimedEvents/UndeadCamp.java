...
import net.battleau.clans.gamer.combat.CombatLogs;
...
import net.battleau.clans.worldevents.types.TimedEvents.ads.UndeadSkeleton;
import net.battleau.clans.worldevents.types.TimedEvents.ads.UndeadZombie;
import net.battleau.clans.worldevents.types.WorldEventMinion;
import net.battleau.clans.worldevents.types.nms.BossSkeleton;
import net.battleau.clans.worldevents.types.nms.BossZombie;
